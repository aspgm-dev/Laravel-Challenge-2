             ...
             <div class="card">
                 <div class="card-body">
                     ...
                     <div class="row">
                         ...
                         <div class="row mr-2">
                             <form action="{{ route('admin.tag.index') }}" method="get" class="row mr-1"
                                 id="filterForm">
 ...
 <div class="modal fade" id="createTag" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
             ...
             <form action="{{ route('admin.tag.store') }}" method="POST">
                 ...
                 <div class="modal-body">
                     <div class="form-group">
                         ...
                         <input type="text" name="tag_name" id="" class="form-control" placeholder="Name">
                     </div>
                 </div>
